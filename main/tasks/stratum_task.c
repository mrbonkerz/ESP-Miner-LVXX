...
void stratum_primary_heartbeat(void * pvParameters)
{
    ...
    while (1)
    {
        ...
        int send_uid = 1;
        STRATUM_V1_subscribe(sock, send_uid++, GLOBAL_STATE->DEVICE_CONFIG.family.asic.name, GLOBAL_STATE->DEVICE_CONFIG.board_version);
...
void stratum_task(void * pvParameters)
{
    ...
    while (1) {
        ...
        STRATUM_V1_subscribe(GLOBAL_STATE->sock, GLOBAL_STATE->send_uid++, GLOBAL_STATE->DEVICE_CONFIG.family.asic.name, GLOBAL_STATE->DEVICE_CONFIG.board_version);
