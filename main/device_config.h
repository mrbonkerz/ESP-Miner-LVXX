...
static const DeviceConfig default_configs[] = {
    { .board_version = "300",  .family = FAMILY_LV06,        .EMC2302 = true, .TMP1075 = true,                                            .temp_offset = 5,   .TPS546 = true,                                                           .power_consumption_target = 40, },
    ...
    { .board_version = "300A", .family = FAMILY_LV06,        .EMC2302 = true, .TMP1075 = true,                                            .temp_offset = 5,   .TPS546 = true,                                                           .power_consumption_target = 40, },
    { .board_version = "301A", .family = FAMILY_LV07,        .EMC2302 = true, .TMP1075 = true,                                            .temp_offset = 5,   .TPS546 = true,                                                           .power_consumption_target = 40, },
    { .board_version = "302A", .family = FAMILY_LV08,        .EMC2302 = true, .TMP1075 = true,                                            .temp_offset = 5,   .TPS546_LV08 = true,                                                      .power_consumption_target = 140,},
